...
<h1 class="text-center mb-3">Sign In</h1>
    ...
    <div class="row g-2 mt-0">
      <div class="col">
        <input type="email" name="email" class="form-control mt-1" placeholder="email" aria-label="Email" value="${email}">
      </div>

        <input type="text" name="password" class="form-control mt-3" placeholder="password" aria-label="Password">
    </div>
    <c:if test="${not empty error}">
    <p class ="text-center fs-4 fw-bold text-danger mt-3">${error}</p>
    </c:if>
